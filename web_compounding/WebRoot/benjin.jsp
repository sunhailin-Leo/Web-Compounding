...
<script type="text/javascript" src="request.js"></script>
	...
	<script>	
        function add(){
       		var i =	parseFloat(document.getElementById("num2").value);//期限
       		var j = parseFloat(document.getElementById("num3").value);//利率
       		var k = parseFloat(document.getElementById("endMoney").value);//终值
       		//Double=money/(Math.pow((1+r),years));
        	var sum=k/(Math.pow((1+j),i));
    ...
    <script>
		function win(){
			window.onload=document.getElementById("num2").focus();
		}
	</script>
...
<body onload="win()">
	...
	<div id="TabMain">
		<div class="tabItemContainer">
			...
			<li><a href="benjin.jsp" class="tabItemCurrent">求初值</a></li>
