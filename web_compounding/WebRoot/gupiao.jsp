...
<link rel="stylesheet" href="mycss.css" type="text/css" />
	...
	<script>	
        function add(){
       		...
       		//Math.log(endmoney/startmoney)/Math.log(1+r);
        	var sum=Math.log(j/i)/Math.log(1+k);
          	text=document.getElementById("num2");
          	text.value=sum;
        }
    </script>
<script>
...
<body onload="win()">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							<li class=""><a href="list.jsp">Funciton Comming Soon<span class="sr-only">(current)</span>
							</a>
							</li>
	...
	<div id="TabMain">
		<div class="tabItemContainer">
			...
			<li><a href="gupiao.jsp" class="tabItemCurrent">股票收益</a></li>
			...
			<div class="tabBodyItem tabBodyCurrent">
				<p>欢迎使用投资计算器</p>
						...
						<table class="table">
							...
							<tr >
								<td  class="labelTd">
									<span class="red">*</span>所需年数：
								</td>
								<td>
									<input class="form-control" name="years" id="num2" disabled="disabled">
									<span class="errorMsg"></span>
								</td>
							</tr>	
							<tr>
